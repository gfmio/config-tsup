...
export const ALL_EXTERNALS = [NOT_LOCAL_FILES_REGEX, NODE_PROTOCOL_REGEX, BUN_PROTOCOL_REGEX];
export const NODE_BUILTINS_EXTERNAL = [NODE_PROTOCOL_REGEX] as const;
export const BUN_BUILTINS_EXTERNAL = ['bun', BUN_PROTOCOL_REGEX, NODE_PROTOCOL_REGEX] as const;
export const REACT_EXTERNALS = ['react', 'react-dom'] as const;
export const VUE_EXTERNALS = ['vue', '@vue/*'] as const;
